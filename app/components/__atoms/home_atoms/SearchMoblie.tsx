...
const SearchMoblie = () => {
  ...
  return (
    <div>
      <div className='max-w-[510px]  h-[40px]  flex justify-between items-center border-b-[1px] border-[#D04175]'>
        <AnimatePresence mode='wait'>
          <motion.input
            ...
            className='w-full h-full border-[1px] bg-transparent border-none placeholder:font-RedRose placeholder:font-light placeholder:text-[18px] placeholder:leading-[40px] placeholder:text-[#C6C3C4] placeholder:max-w-[475px] focus:outline-none font-RedRose text-[18px] leading-[40px] text-[#C6C3C4]'
          />
        </AnimatePresence>
